...
public enum NodePropertyEnum {
    ...
    NODE_PROPERTY_HRBP(6, "HRBP", 1,BPMN_NODE_PARAM_SINGLE),
    NODE_PROPERTY_CUSTOMIZE(7, "自选模块", 0,BPMN_NODE_PARAM_MULTIPLAYER),
    ...
    NODE_PROPERTY_START_USER(12,"发起人",0,BPMN_NODE_PARAM_SINGLE),
    NODE_PROPERTY_DIRECT_LEADER(13,"直属领导",0,BPMN_NODE_PARAM_SINGLE),
    ;
