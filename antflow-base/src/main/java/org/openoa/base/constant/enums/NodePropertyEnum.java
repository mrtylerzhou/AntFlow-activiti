...
public enum NodePropertyEnum {
    ...
    NODE_PROPERTY_FORM_RELATED(16,"表单中相关人员",1,BPMN_NODE_PARAM_MULTIPLAYER),
    NODE_PROPERTY_ZDY_RULES(17,"自定义",1,BPMN_NODE_PARAM_MULTIPLAYER),
    NODE_PROPERTY_PREV_NODE_RELATED(18,"上一节点相关人员",1,BPMN_NODE_PARAM_MULTIPLAYER),
    NODE_PROPERTY_LABEL_BASED(20,"根据标签选择",1,BPMN_NODE_PARAM_MULTIPLAYER),
    ;
