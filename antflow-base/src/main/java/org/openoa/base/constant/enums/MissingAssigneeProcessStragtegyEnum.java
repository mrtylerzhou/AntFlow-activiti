...
@Getter
public enum MissingAssigneeProcessStragtegyEnum {
    SKIP(0, "跳过"),//注意,这里的跳过指的是不生成审批任务节点,即流程图里没有当前缺失审批人的节点
    TRANSFER_TO_ADMIN(1, "转办给管理员"),//转给管理员需实现BpmnProcessAdminProvider接口
    ;
