...
//  }
  ...
  public void performSchemaOperationsProcessEngineBuild() {
    ...
    if (ProcessEngineConfiguration.DB_SCHEMA_UPDATE_CREATE_DROP.equals(databaseSchemaUpdate)
        ...
        || ProcessEngineConfiguration.DB_SCHEMA_UPDATE_TRUE.equals(databaseSchemaUpdate)) {
      dbSchemaCreate();
    }
    // DB_SCHEMA_UPDATE_FALSE (none): no-op, skip all schema checks for faster startup
  }
