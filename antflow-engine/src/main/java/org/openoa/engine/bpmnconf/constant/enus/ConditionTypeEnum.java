...
public enum ConditionTypeEnum {
    ...
    CONDITION_PURCHASE_TYPE(6, "采购类型", "purchaseType", 2, Integer.class,
            BpmnNodeConditionsEmptyAdp.class, BpmnStartConditionsVo.class, "purchaseType", PurchaseTypeJudge.class),
