...
public interface DicDataMapper extends BaseMapper<DictData> {
    ...
    List<DictData> selectDIYFormCodePageList(Page page, @Param("vo") TaskMgmtVO taskMgmtVO);
    List<DictData> selectDIYActiveFormCodeList(@Param("vo") TaskMgmtVO taskMgmtVO);
}
