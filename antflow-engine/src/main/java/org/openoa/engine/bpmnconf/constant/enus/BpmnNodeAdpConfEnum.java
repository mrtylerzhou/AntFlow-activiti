...
public enum BpmnNodeAdpConfEnum {
    ...
    ADP_CONF_NODE_PROPERTY_FORM_RELATED_USERS(NodePropertyEnum.NODE_PROPERTY_FORM_RELATED),
    ADP_CONF_NODE_PROPERTY_UDR_USERS(NodePropertyEnum.NODE_PROPERTY_ZDY_RULES),
    ADP_CONF_NODE_PROPERTY_PREV_NODE_RELATED_USERS(NodePropertyEnum.NODE_PROPERTY_PREV_NODE_RELATED),
    ;
