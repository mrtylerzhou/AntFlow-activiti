...
import org.openoa.engine.bpmnconf.service.flowcontrol.DefaultTaskFlowControlService;
...
public class CreateAndTakeTransitionCmd implements Command<java.lang.Void>
{
	...
	{
		//创建新任务
		Logger.getLogger(DefaultTaskFlowControlService.class.getSimpleName()).info(
