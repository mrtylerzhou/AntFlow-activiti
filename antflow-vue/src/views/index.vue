              ...
              <el-row :gutter="5">
                <el-col :xs="12" :sm="12" :md="12" :lg="4">
                  <el-button type="primary" icon="Cloudy" plain style="width: 100%;"
                    @click="goTarget('https://gitee.com/ldhnet')">访问码云</el-button>
                </el-col>
                <el-col :xs="12" :sm="12" :md="12" :lg="4">
                  <el-button type="primary" icon="Cloudy" plain style="width: 100%;"
      ...
      <el-col :xs="24" :sm="24" :md="12" :lg="8" style="margin-bottom: 5px;">
        <el-card class="update-log">
          ...
          <el-collapse accordion>
            <el-collapse-item title="v9.0.0 - 2025-06-27">
              <ol>
                <li>流程通知模块对接</li>
              </ol>
            </el-collapse-item>
            <el-collapse-item title="v8.0.0 - 2025-05-01">
              <ol>
                <li>流程设计条件节点实现条件分组</li>
              </ol>
            </el-collapse-item>
            <el-collapse-item title="v7.0.0 - 2025-03-05">
              <ol>
                <li>实现发起人自选审批人</li>
              </ol>
            </el-collapse-item>
            <el-collapse-item title="v6.0.0 - 2025-02-15">
              <ol>
                <li>添加并行审批功能</li>
                <li>代码深度优化</li>
                <li>关键代码添加注释</li>
            ...
            <el-collapse-item title="v5.0.0 - 2025-01-11">
              <ol>
                <li>低代码表单优化</li>
              </ol>
            </el-collapse-item>
            ...
            <el-collapse-item title="v2.0.0 - 2024-08-08">
              <ol>
                <li>Mock Data</li>
                <li>其他细节优化</li>
              </ol>
