    ...
    <el-row style="min-height: 260px;" :gutter="5">
      <el-col :span="15">
        <div style="border: 1px solid rgb(236 236 236); height: 250px;  width: 560px;">
          <e-sign ref="esignRef" :width="560" :height="250" :image="props.image" :is-crop="options.isCrop"
            :line-width="options.lineWidth" :line-color="options.lineColor" v-model:bg-color="options.bgColor" />
        </div>
      </el-col>
      <el-col :span="9">
