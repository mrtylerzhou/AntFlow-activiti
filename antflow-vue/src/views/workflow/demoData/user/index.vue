    ...
    <div class="app-container">
        <div class="query-box">
            <el-form :model="query" ref="queryRef" :inline="true" v-show="showSearch">
                <el-form-item label="姓名" prop="userName">
                    <el-input v-model="query.userName" placeholder="请输入姓名" clearable style="width: 180px"
                        @keyup.enter="handleQuery" />
                </el-form-item>
                <el-form-item label="手机号" prop="mobile">
                    <el-input v-model="query.mobile" placeholder="请输入手机号" clearable style="width: 180px"
                        @keyup.enter="handleQuery" />
                </el-form-item>
                <el-form-item>
        ...
        <div class="table-box">
            <el-table v-loading="loading" :data="dataList" border height="calc(100vh - 260px)">
                ...
                <el-table-column label="直属领导" align="center" prop="leaderName" min-width="110" show-overflow-tooltip />
                <el-table-column label="HRBP" align="center" prop="hrbpName" min-width="110" show-overflow-tooltip />
...
import { getUserListPage } from "@/api/workflow/demoDataApi";
...
async function getList() {
    loading.value = true;
    await getUserListPage(pageDto.value, query.value).then(response => {
...
/** 重置按钮操作 */
function resetQuery() {
    query.value = { userName: undefined, mobile: undefined };
    handleQuery();
}
