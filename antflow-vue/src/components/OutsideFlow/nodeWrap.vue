...
<template>
  <div class="node-wrap" v-if="nodeConfig.nodeType != 2">
    ...
    <outsideAddNode v-model:childNodeP="nodeConfig.childNode" />
  </div>
        ...
        <div class="col-box" v-for="(item, index) in nodeConfig.conditionNodes" :key="index">
          <div class="condition-node">
            <div class="condition-node-box">
              ...
              <outsideAddNode v-model:childNodeP="item.childNode" />
            </div>
          </div>
          <outsideNodeWrap v-if="item.childNode" v-model:nodeConfig="item.childNode" />
  ...
  <outsideNodeWrap v-if="nodeConfig.childNode" v-model:nodeConfig="nodeConfig.childNode"/>
</template>
<script setup>
import { onMounted, ref, watch, getCurrentInstance, computed } from "vue";
import outsideNodeWrap from "@/components/OutsideFlow/nodeWrap.vue";
import outsideAddNode from "@/components/OutsideFlow/addNode.vue";
