<template>
    <div>
        <el-table v-loading="loading" :data="activityList">
            ...
            <el-table-column label="流程环节" align="left" prop="taskName" />
            <el-table-column label="执行人" align="left" prop="verifyUserName">
            ...
            <el-table-column label="审批意见" align="left" prop="remark" />
            <el-table-column label="处理时间" align="left" prop="verifyDate" width="180">
                <template #default="scope">
