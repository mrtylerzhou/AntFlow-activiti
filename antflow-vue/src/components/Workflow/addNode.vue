        ...
        <div class="add-node-btn">
            <el-popover placement="right-start" v-model="visible" aria-hidden="true" width="auto">
                ...
                <div class="add-node-popover-body align-left">
                    ...
                    <a class="add-node-popover-item finish-approver-node" @click="addType(20)">
                        <div class="item-wrapper">
                            <svg-icon icon-class="finish-process" class="iconfont" />
                            <p>完成审批</p>
                        </div>
                    </a>
                </div>
                ...
                <div class="add-node-popover-body align-left">
                    <a class="add-node-popover-item condition-return-starter-node" @click="addType(29)">
                        <div class="item-wrapper">
                            <svg-icon icon-class="conditional-drive-to-starter" class="iconfont" />
                            <p>条件退回发起人</p>
                        </div>
                    </a>
                </div>
